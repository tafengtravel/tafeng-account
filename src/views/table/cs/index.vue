  ...
  <div class="app-container">
    ...
    <div class ="el-col-24">
      <el-table v-loading="listLoading" :data="itemData" style="width: 100%" :row-class-name="tableRowClassName" empty-text="沒有資料">
        ...
        <el-table-column prop="count" label="筆數" width='75%' fixed sortable :sort-method = "(a,b)=>{return a.count - b.count}"></el-table-column>
        ...
        <el-table-column prop="cs" label="客服" width='75%' sortable :sort-method = "(a,b)=>{return a.cs - b.cs}"></el-table-column>
        <el-table-column prop="depDate" label="出發日期" width='125%' sortable :sort-method = "(a,b) =>a.depDate.localeCompare(b.depDate)"></el-table-column>
        <el-table-column prop="endDate" label="結束日期" width='125%' sortable :sort-method = "(a,b) =>a.endDate.localeCompare(b.endDate)"></el-table-column>
        ...
        <el-table-column prop="insurance1" label="旅責險" width='125%' :formatter="insurance" sortable :sort-method = "(a,b)=>{return a.insurance1 - b.insurance1}"></el-table-column>
        <el-table-column prop="other" label="備註" width='125%' sortable :sort-method = "(a,b)=>a.other.localeCompare(b.other)"></el-table-column>
        <el-table-column prop="" label="編輯" width='125%'>
