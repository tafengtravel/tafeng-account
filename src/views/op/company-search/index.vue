<template>
  <div class="app-container">
    ...
    <div class ="el-col-24">
      <el-table v-loading="listLoading" show-summary :summary-method="getSummaries" :default-sort = "{prop: 'number',order: 'ascending'}" :data="itemData" style="width: 100%" :row-class-name="tableRowClassName" empty-text="沒有資料">
