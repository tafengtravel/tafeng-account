  ...
  <div class="app-container">
      ...
      <el-form :model="ruleForm" :inline="true" :rules="rules" ref="ruleForm" label-position="left" label-width="70px" class="demo-ruleForm">
        ...
        <el-card class="box-card">
          ...
          <el-form-item label="年齡" label-width="90px">
            ...
            <el-select v-model="ruleForm.age" placeholder="主辦人年齡" style="width: 250px;" v-else>
              ...
              <el-option label="60-99" value="60-99"></el-option>
            </el-select>
          </el-form-item>
        ...
        <el-card class="box-card">
          ...
          <el-form-item label="合約備註項" label-width="110px">
          ...
          <el-form-item label="合約項目" label-width="100px">
        ...
        <el-card class="box-card">
          ...
          <span v-for="(priceDetailItem,index) in ruleForm.priceDetailItem.length">
            <el-form-item :label="'品項'+(index+1).toString()" label-width="60px">
        ...
        <el-card class="box-card">
          ...
          <el-row></el-row>
          <el-form-item label="主管核實" label-width="100px">
        ...
        <el-card class="box-card">
          <span v-for="(payDetailCompany,index) in ruleForm.payDetailCompany.length">
            ...
            <el-form-item label="品項">
              ...
              <el-input v-model="ruleForm.payDetailItem[index]" v-else style="width: 280px;"></el-input>
            </el-form-item> 
            <el-form-item label="明細">
              ...
              <el-input v-model="ruleForm.payDetailDetail[index]" v-else style="width: 280px;"></el-input>
            </el-form-item> 
            ...
            <el-form-item label="付款方式" label-width="100px">
              ...
              <el-select v-model="ruleForm.payDetailType[index]" v-else placeholder="付款方式" style="width: 130px;">
                ...
                <el-option label="轉團金" value="轉團金"></el-option>
                <el-option label="其他" value="其他"></el-option>
              </el-select>
            </el-form-item>
            ...
            <el-form-item label="匯費 $15" label-width="90px">
            ...
            <el-row></el-row>
            <el-form-item label="金額" label-width="100px">
              ...
              <el-input v-model="ruleForm.payDetailDlPay1[index]" @input="count" v-else style="width: 160px;" ></el-input>
            </el-form-item> 
            <el-form-item label="付款方式" label-width="100px">
              ...
              <el-select v-model="ruleForm.payDetailDlType1[index]" placeholder="付款方式" v-else style="width: 130px;">
                <el-option label="轉帳" value="轉帳"></el-option>
                <el-option label="郵局" value="郵局"></el-option>
                <el-option label="刷卡" value="刷卡"></el-option>
                <el-option label="現金" value="現金"></el-option>
            ...
            <el-form-item label="付款證明" label-width="100px">
              ...
              <el-input v-model="ruleForm.payDetailDlProve1[index]" @input="count" v-else></el-input>
            </el-form-item>
            <el-form-item label="OP核實" label-width="100px" class="op">
            ...
            <el-form-item label="金額" label-width="100px">
              ...
              <el-input v-model="ruleForm.payDetailDlPay2[index]" v-else style="width: 160px;" ></el-input>
            </el-form-item> 
            <el-form-item label="付款方式" label-width="100px">
              ...
              <el-select v-model="ruleForm.payDetailDlType2[index]" placeholder="付款方式" v-else style="width: 130px;">
                <el-option label="轉帳" value="轉帳"></el-option>
                <el-option label="郵局" value="郵局"></el-option>
                <el-option label="刷卡" value="刷卡"></el-option>
                <el-option label="現金" value="現金"></el-option>
            ...
            <el-form-item label="付款證明" label-width="100px">
              ...
              <el-input v-model="ruleForm.payDetailDlProve2[index]" v-else></el-input>
            </el-form-item>
            <el-form-item label="OP核實" label-width="100px" class="op">
